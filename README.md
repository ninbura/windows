...
- #### file explorer
  ...
  - `ShowFrequentlyUsedFoldersInHome` [`true`/`false`] - Makes it so quick access pins show in the "Home" directory. I Like to enable this, so when I launch explorer the launch screen shows all my pins.
